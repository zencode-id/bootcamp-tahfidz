...
CREATE INDEX idx_class_transfers_student_id ON class_transfers(student_id);
CREATE INDEX idx_class_transfers_from_class_id ON class_transfers(from_class_id);
CREATE INDEX idx_class_transfers_to_class_id ON class_transfers(to_class_id);
```
...
_SQL Reference untuk Tahfidz Bootcamp API v1.3.0_
